...
export default function ChatMessages({
  ...
  if (messages.length === 0) {
    return (
      <div className="text-center py-16 bg-gray-50 flex-1">
          ...
          return (
            ...
            >
              ...
              >
                ...
                {isAssistant ? (
                  isTyping ? (
                    // Typing indicator — no background
                    ...
                    <div className="relative w-full rounded-2xl px-5 py-4 text-sm leading-relaxed bg-gray-100 text-gray-800 overflow-visible">
                  ...
                  <div className="flex items-end flex-col w-1/3">
                    <div className="bg-gray-100 text-black text-sm rounded-2xl px-4 py-3 whitespace-pre-wrap break-words inline-flex flex-col items-end">
                      <MarkdownRenderer content={msg.content} />
                ...
                {/* User Avatar */}
                {!isAssistant && (
                  <div className="w-9 h-9 bg-gray-600 rounded-lg flex items-center justify-center shadow-sm shrink-0">
